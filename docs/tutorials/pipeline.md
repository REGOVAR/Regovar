...
* [Créer un pipeline pour Regovar avec Docker](pipeline/tuto_003.md)
    * [Ex1: Pipeline simple](tuto_004.md)
    * [Ex2: Pipeline paramétrable](tuto_005.md)
    * [Ex3: Pipeline avancé](tuto_006.md)
* [Partager son pipeline avec les autres serveurs](pipeline/tuto_007.md)
