...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
TU_PUBLIC_FIELDS = ["id", "identifier", "firstname", "lastname", "sex", "comment", "dateofbirth", "dateofdeath", "create_date", "update_date", "jobs_ids", "samples_ids", "files_ids", "analyses_ids", "projects_ids", "jobs", "samples", "analyses", "files", "indicators", "projects_ids", "projects"]
...
class TestModelSubject(unittest.TestCase):
    ...
    def test_from_id(self):
        ...
        self.assertEqual(s.identifier, "S2")


    def test_from_ids(self):
        """ from_ids """
        self.assertEqual(Subject.from_ids([]), [])
        s = Subject.from_ids([2,15415,1])
    ...
    def test_count(self):
        """ count """
        self.assertEqual(Subject.count(), 2)
