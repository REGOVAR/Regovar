...
def job_init(self, loading_depth=0, force=False):
    """
        Init properties of a job :
            ...
            - monitoring    : json              : monitoring information; false when not loaded or not available
    ...
    try:
        ...
        self.outputs = []
        self.pipeline = None
        self.monitoring = False # monioring information loaded only when requested (see core.jobs.monitoring) 
