...
--
/*INSERT INTO reference(name, description, url, table_suffix) VALUES ('Hg38', 'Human Genom version 38', 'http://hgdownload.soe.ucsc.edu/goldenPath/hg38/database/', 'hg38');
...
-- 4915f6f892d359e93ac0631fd1e76f7a = SELECT MD5(concat(2, 'refgene_hg38',      '2017-09-24 23:51'))
-- c721472eed11a0483ced649c0a53e37c = SELECT MD5(concat(2, 'refgene_trx_hg38',  '2017-09-24 23:51'))
-- ce68af55f377bb8bcceb397757655022 = SELECT MD5(concat(2, 'refgene_exon_hg38', '2017-09-24 23:51'))
...
INSERT INTO annotation_database(uid, reference_id, version, name, name_ui, description, url, ord, update_date, jointure, type) VALUES
  ('4915f6f892d359e93ac0631fd1e76f7a', 2,
  '2017-09-24 23:51', 
  'refgene_hg38', 
  'refGene', 
  ...
  ('c721472eed11a0483ced649c0a53e37c', 2,
  '2017-09-24 23:51', 
  'refgene_trx_hg38', 
  'refGene Transcripts', 
...
--   ('ce68af55f377bb8bcceb397757655022', 2,
--   '2017-09-24 23:51',
--   'refgene_exon_hg38', 
--   'refGene Exons', 
