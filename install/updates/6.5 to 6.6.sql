...
IF current_version == '6.5' THEN
    ...
    -- New field VAF
    INSERT INTO annotation_field(database_uid, ord, name, name_ui, type, description, meta) 
    VALUES ('492f18b60811bf85ce118c0c6a1a5c4a', 13, 's{}_vaf', 'VAF', 'sample_array', 'Variant allelic frequence. (1=100%)', '{"type": "float"}');
    ...
    UPDATE annotation_field SET ord=2 WHERE name='s{}_qual';
