...
ALTER TABLE public.refgene_trx_hg19
  OWNER TO regovar;
...
--   START 1
--   CACHE 1;
-- ALTER TABLE public.refgene_trx_hg19_id_seq
--   OWNER TO regovar;
...
INSERT INTO public.annotation_field(database_uid, ord, wt_default, name, name_ui, type, description, meta) VALUES
  ...
  ('0f562de4f9474fd90132273d9414cc0a', 10, False, 'trxcount',      'trxcount',     'int',    'Number of transcript in the gene.', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 12, False, 'name2',         'name2',        'string', 'Gene name.', NULL),
  
  ('469120ae7914cc007f6aba8076673910', 1,  True,  'name',          'name',         'string', 'Transcript name.', NULL),
  ('469120ae7914cc007f6aba8076673910', 3,  False, 'strand',        'strand',       'string', 'Which DNA strand contains the observed alleles.', NULL),
  ('469120ae7914cc007f6aba8076673910', 4,  False, 'txstart',       'txstart',      'int',    'Transcription start position.', NULL),
  ('469120ae7914cc007f6aba8076673910', 5,  False, 'txend',         'txend',        'int',    'Transcription end position.', NULL),
  ('469120ae7914cc007f6aba8076673910', 6,  False, 'txrange',       'txrange',      'range',  'Transcription region [start-end].', NULL),
  ('469120ae7914cc007f6aba8076673910', 7,  False, 'cdsstart',      'cdsstart',     'int',    'Coding region start.', NULL),
  ('469120ae7914cc007f6aba8076673910', 8,  False, 'cdsend',        'cdsend',       'int',    'Coding region end.', NULL),
  ('469120ae7914cc007f6aba8076673910', 9,  False, 'cdsrange',      'cdsrange',     'range',  'Coding region [start-end].', NULL),
  ('469120ae7914cc007f6aba8076673910', 10, False, 'exoncount',     'exoncount',    'int',    'Number of exons in the gene.', NULL),
  ('469120ae7914cc007f6aba8076673910', 11, False, 'score',         'score',        'int',    'Score ?', NULL),
  ('469120ae7914cc007f6aba8076673910', 12, False, 'name2',         'name2',        'string', 'Gene name.', NULL),
  ('469120ae7914cc007f6aba8076673910', 13, False, 'cdsstartstat',  'cdsstartstat', 'string', 'Cds start stat, can be "non", "unk", "incompl" or "cmp1".', NULL),
  ('469120ae7914cc007f6aba8076673910', 14, False, 'cdsendstat',    'cdsendstat',   'string', 'Cds end stat, can be "non", "unk", "incompl" or "cmp1".', NULL),

  ('8cb1ac768951cef7ae600256d97aed03', 1,  True,  'name',          'name',         'string', 'Transcript name.', NULL),
  ...
  ('8cb1ac768951cef7ae600256d97aed03', 7,  False, 'exonstart',     'exonstart',    'int',    'Exon start.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 8,  False, 'exonend',       'exonend',      'int',    'Exon end.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 9,  False, 'exonrange',     'exonrange',    'range',  'Exon region [start-end].', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 10, False, 'exonpos',       'exonpos',      'int',    'Position of the exons in the gene.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 10, False, 'exoncount',     'exoncount',    'int',    'Number of exons in the gene.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 11, False, 'score',         'score',        'int',    'Score ?', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 12, False, 'name2',         'name2',        'string', 'Gene name.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 13, False, 'cdsstartstat',  'cdsstartstat', 'string', 'Cds start stat, can be "non", "unk", "incompl" or "cmp1".', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 14, False, 'cdsendstat',    'cdsendstat',   'string', 'Cds end stat, can be "non", "unk", "incompl" or "cmp1".', NULL);
