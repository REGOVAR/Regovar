...
INSERT INTO public.annotation_field(database_uid, ord, name, name_ui, type, description, meta) VALUES
  ...
  ('2c0a7043a9e736eaf14b6614fff102c0', 1,  'is_dom',           'Dominant',                       'bool',         'Heterozygous variant in the sample (single) or in the child (trio).', NULL), -- Variant présent à l'état hétérozygote dans l'échantillon (en singleton) ou chez l'enfant (en trio).
  ('2c0a7043a9e736eaf14b6614fff102c0', 2,  'is_rec_hom',       'Recessif homozygous',            'bool',         'Homozygous variant in the sample (single), or in the child (trio).', NULL), -- Variant présent à l'état homozygote dans l'échantillon (en singleton) ou chez l'enfant (en trio).
  ('2c0a7043a9e736eaf14b6614fff102c0', 3,  'is_rec_htzcomp',   'Recessif compound heterozygous', 'bool',         'Compound heterozygous variants in the sample (single), or in the child (trio).', NULL), -- Variants présents à l'état hétérozygotes composite dans l'échantillon (singleton) ou chez l'enfant (en trio).
  ...
  ('2c0a7043a9e736eaf14b6614fff102c0', 6,  'is_aut',           'Autosomal',                      'bool',         'Autosomal variant in the sample (single), or in the child (trio).', NULL), -- Variant suivant un mode de transmission autosomique.
  ('2c0a7043a9e736eaf14b6614fff102c0', 7,  'is_xlk',           'X-linked',                       'bool',         'X-linked variant in the sample (single), or in the child (trio).', NULL), -- Variant suivant un mode de transmission lié à l'X.
  ('2c0a7043a9e736eaf14b6614fff102c0', 8,  'is_mit',           'Mitochondrial',                  'bool',         'Mitochondrial variant in the sample (single), or in the child (trio).', NULL), -- Variant suivant un mode de transmission mitochondrial.
